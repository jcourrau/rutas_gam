...
# Basado en el Articulo 98 de la Ley de Tránsito por Vías Públicas Terrestres y Seguridad Vial
VELOCIDADES_POR_VIA = {
    "motorway": 80,
    "motorway_link": 60,
    "trunk": 70,
...
def cargar_paradas(ruta):
    """Carga la tabla fija de paradas y variables de importancia."""
    return pd.read_csv(ruta)


def calcular_importancia(paradas, alfa=0.6, beta=0.4):
    """Calcula y ordena el peso de importancia de cada parada."""
...
def usar_nombres_visuales(tabla):
    """Cambia los nombres internos por etiquetas adecuadas para mostrar."""
